...
public enum ErrorCode implements BaseErrorCode {
    ...
    PLACE_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMON404_2", "해당 장소를 찾을 수 없습니다."),
    INVALID_DISTANCE(HttpStatus.BAD_REQUEST, "COMMON400_2", "유효하지 않은 거리 값입니다."),
    INVALID_BUDGET(HttpStatus.BAD_REQUEST, "COMMON400_3", "유효하지 않은 예산 값입니다."),
    INVALID_LOCATION(HttpStatus.BAD_REQUEST, "COMMON400_4", "유효하지 않은 좌표 값입니다."),
    ...
    MEMBER_LOCATION_NOT_SET(HttpStatus.NOT_FOUND, "MEMBER404_2", "위치 설정이 필요합니다"),
